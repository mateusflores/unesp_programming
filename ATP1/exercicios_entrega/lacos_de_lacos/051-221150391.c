// Mateus Gomes Flores          Programa Campo Minado
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
#include <time.h>
...
int main(int argc, char* argv[]) {
    ...
    do {
        ...
        for (i=0; i<tam; i++) {            
            for (j=0; j<tam; j++) {
                if (campo[i][j] == 8) {     // Caso uma celula esteja cercada por 8 bombas, a flag eh ativada e o campo eh refeito ateh que a condicao seja satisfeita
                    flag_cercado = true;
                    cont = 0;
                    break;
                }
